 ...
 */
  ...
  * Breadcrumbs 
  */
function osto_web_delta_blocks_breadcrumb($variables) {
  ...
  */
function osto_web_preprocess_field(&$vars) {
 ...
 * TEXTAREAS
 */
function osto_web_textarea($variables) {
...
function osto_web_preprocess_page(&$vars, $hook) {
  if (isset($vars['is_front']))
    unset($vars['page']['content']['system_main']['default_message']);
}

function osto_web_preprocess_forum_list(&$variables) {
 ...
 * Form Alter
 */
function osto_web_form_alter($form, $form_state) {
	$views = array(
